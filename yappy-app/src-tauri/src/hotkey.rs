...
mod desktop_impl {
    ...
    pub fn register_from_settings<R: tauri::Runtime>(
        ...
        let read_shortcut = parse_combo(&read_combo)
            .unwrap_or_else(|_| Shortcut::new(Some(Modifiers::ALT | Modifiers::SUPER), Code::KeyR));
        ...
        handle
            .global_shortcut()
            .on_shortcut(read_shortcut, move |_app, sc, ev| {
        ...
        handle
            .global_shortcut()
            .on_shortcut(pause_shortcut, move |_app, sc, ev| {
        ...
        if let Ok(clip_shortcut) = parse_combo(&clipboard_combo) {
            ...
            handle
                .global_shortcut()
                .on_shortcut(clip_shortcut, move |_app, sc, ev| {
